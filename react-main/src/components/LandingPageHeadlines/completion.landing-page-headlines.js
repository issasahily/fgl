...
const Completion = () => {
  ...
  const generateCompletion = async () => {
    ...
    const res = await openai.createCompletion({
      prompt: "generate" + prompt3 + "landing page headlines on" + prompt2 + "Language:"+prompt4,
                    ...
                    <div className="row border-bottom" style={{backgroundColor: '#fff'}}>
                      ...
                      <div className="col-2 text-center mt-4 ms-4">
                        <div className="rounded-3">
                          <img src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/null/external-clickbait-digital-marketing-flaticons-flat-flat-icons.png" width="50px"/>
                        </div>
                      </div>
                      <div className="col-9">
                        <h2 className="badge_h_two mt-3">Landing Page Headlines</h2>
                        <p className="ms-2">Generate Landing Page Headlines</p>
                      </div>

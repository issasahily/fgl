...
const Completion = () => {
  ...
  const generateCompletion = async () => {
    ...
    const res = await openai.createCompletion({
      prompt: "generate" + prompt3 + "LinkedIn Ad Headlines on" + prompt2 + "Language:"+prompt4,
                ...
                <div className="row ms-lg-21 ms-md-21">
                  <div className="col-12 col-lg-6 border-end" style={{backgroundColor: '#f8fafd'}}>
                    <div className="row border-bottom" style={{backgroundColor: '#fff'}}>
                      ...
                      <div className="col-9">
                        <h2 className="badge_h_two mt-3">LinkedIn Ad Headlines</h2>
                        <p className="ms-2">Generate LinkedIn Ad Headlines</p>
                      </div>

          ...
          <div>
            ...
            <div className="wrapper d-flex align-items-stretch">
              <nav id="sidebar" className="border-end ">
                ...
                <div className="p-5">
                  ...
                  <ul className="list-unstyled components mb-5 mt-5">
                    <li className="active ms">
                      <a href="ads" className="text-decoration-none"><span className="fa fa-home me-3" /> Home</a>
                    </li>
                    <li>
                ...
                <li>
                    <a href="../twitt-writing" class="text-decoration-none"><span class="bi bi bi-twitter me-3"></span> Twitt Writing</a>
                </li>
                <li>
                    <a href="../business-case-study" class="text-decoration-none mb-5"><span class="bi bi bi-receipt-cutoff me-3"></span> Business Case Study</a>
                </li> */}
                  </ul>
              ...
              {/* Page Content  */}
              <div id="content">
                {/* <h2 class="badge_h_two"><i class="bi bi-badge-ad-fill home_icons me-4"></i> Ads Description Writing</h2>

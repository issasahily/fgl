...
const Completion = () => {
  ...
  const generateCompletion = async () => {
    ...
    const res = await openai.createCompletion({
      //prompt: prompt + prompt2 + prompt3 + prompt4 + 'united stated',
      prompt: "generate" + prompt3 + "unique value propositions on" + prompt2 + "Language:"+prompt4,
                  ...
                  <div className="col-12 col-lg-6 border-end" style={{backgroundColor: '#f8fafd'}}>
                    <div className="row border-bottom" style={{backgroundColor: '#fff'}}>
                      ...
                      <div className="col-2 text-center mt-4 ms-4">
                        ...
                        <img src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/null/external-unique-traditional-marketing-flaticons-flat-flat-icons.png" width="50px"/>
                        </div>
                      </div>
                      <div className="col-9">
                        <h2 className="badge_h_two mt-3">Unique Value Propositions</h2>
                        <p className="ms-2">Generate Unique Value Propositions</p>
                      </div>
                    ...
                    <div className="row overflow-scroll">
                      ...
                      <div className="col-12">
                        <div className="ms-3 me-2 mt-4 mb-4">
                          <label className="badge_ai mb-1"><b>Ideas / Topic</b></label>
                          <textarea 

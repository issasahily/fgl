...
const Completion = () => {
  ...
  const generateCompletion = async () => {
    ...
    const res = await openai.createCompletion({
      prompt: "generate" + prompt3 + "Personalized Cold Emails on" + prompt2 + "Language:"+prompt4,
                  ...
                  <div className="col-12 col-lg-6 border-end" style={{backgroundColor: '#f8fafd'}}>
                    <div className="row border-bottom" style={{backgroundColor: '#fff'}}>
                      ...
                      <div className="col-2 text-center mt-4 ms-4">
                        ...
                        <img src="https://img.icons8.com/fluency/96/null/apple-mail.png" width="50px"/>
                        </div>
                      </div>
                      <div className="col-9">
                        <h2 className="badge_h_two mt-3">Personalized Cold Emails</h2>
                        <p className="ms-2">Generate Personalized Cold Emails</p>
                      </div>

...
const Completion = () => {
  ...
  const generateCompletion = async () => {
    ...
    const res = await openai.createCompletion({
      prompt: "show me" + prompt3 + "ways how i can explain this" + prompt2 + "to a child, Language:"+prompt4,
                    ...
                    <div className="row border-bottom" style={{backgroundColor: '#fff'}}>
                      ...
                      <div className="col-2 text-center mt-4 ms-4">
                        <div className="rounded-3">
                          <img src="https://img.icons8.com/emoji/48/null/child-light-skin-tone.png" width="50px"/>
                        </div>
                      </div>
                      <div className="col-9">
                        <h2 className="badge_h_two mt-3">Explain It To a Child</h2>
                        <p className="ms-2">Explain It To a Child</p>
                      </div>

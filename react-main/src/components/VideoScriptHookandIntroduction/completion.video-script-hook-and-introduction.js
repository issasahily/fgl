...
const Completion = () => {
  ...
  const generateCompletion = async () => {
    ...
    const res = await openai.createCompletion({
      prompt: "generate" + prompt3 + "Video Script Hook and Introduction on" + prompt2 + "Language:"+prompt4,
                    ...
                    <div className="row border-bottom" style={{backgroundColor: '#fff'}}>
                      ...
                      <div className="col-2 text-center mt-4 ms-4">
                        <div className="rounded-3">
                          <img src="https://img.icons8.com/external-vectorslab-flat-vectorslab/53/null/external-Video-Reel-multimedia-vectorslab-flat-vectorslab-2.png" width="50px"/>
                        </div>
                      </div>
                      <div className="col-9">
                        <h2 className="badge_h_two mt-3">Video Script Hook</h2>
                        <p className="ms-2">Video Script Hook and Introduction</p>
                      </div>

...
const Completion = () => {
  ...
  const generateCompletion = async () => {
    ...
    const res = await openai.createCompletion({
      prompt: "generate" + prompt3 + "OneShort Blog Post on" + prompt2 + "Language:"+prompt4,
                  ...
                  <div className="col-12 col-lg-6 border-end" style={{backgroundColor: '#f8fafd'}}>
                    <div className="row border-bottom" style={{backgroundColor: '#fff'}}>
                      ...
                      <div className="col-2 text-center mt-4 ms-4">
                        ...
                        <img src="https://img.icons8.com/color/48/null/lowercase.png" width="50px"/>
                        </div>
                      </div>
                      <div className="col-9">
                        <h2 className="badge_h_two mt-3">One Short Blog Post</h2>
                        <p className="ms-2">Generate One Short Blog Post</p>
                      </div>
